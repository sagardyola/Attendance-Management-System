...
namespace AttendanceManagementSystem.Controllers
{
    ...
    public class ClassTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ClassTypeID,ClassTypeName")] ClassType classType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClassTypeID,ClassTypeName")] ClassType classType)
        {
            if (ModelState.IsValid)
            {
